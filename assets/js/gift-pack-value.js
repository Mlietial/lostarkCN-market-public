...
const itemPrices = {
  ...
  "命运破坏石结晶（绑定）": { components: [{ name: "命运破坏石结晶", qty: 1 }], note: "按命运破坏石结晶单价" },
  "命运守护石结晶（绑定）": { components: [{ name: "命运守护石结晶", qty: 1 }], note: "按命运守护石结晶单价" },
  ...
  "匠人的裁缝术：第3阶段": { note: "手动填拍卖单价" },
  "匠人的裁缝术：第4阶段": { note: "手动填拍卖单价" },
  "匠人的冶金术：第3阶段": { note: "手动填拍卖单价" },
  "匠人的冶金术：第4阶段": { note: "手动填拍卖单价" },
  "高级匠人的裁缝术自选箱子": { note: "手动填每箱估值" },
  "高级匠人的冶金术自选箱子": { note: "手动填每箱估值" },
  "幸运材料随机箱子": { note: "手动填每箱估值" },
...
const itemIcons = {
  "命运碎片袋子（小）": icon("命运碎片袋子（小）.jpg"),
  "命运碎片袋子（中）": icon("命运碎片袋子（中）.jpg"),
  "命运碎片袋子（大）": icon("命运碎片袋子（大）.jpg"),
  "冰川之息": icon("冰川之息.jpg"),
  "熔岩之息": icon("熔岩之息.jpg"),
  "命运破坏石": icon("命运破坏石.jpg"),
  "命运守护石": icon("命运守护石.jpg"),
  "命运破坏石结晶": icon("新红石头.png"),
  "命运守护石结晶": icon("新守护石.png"),
  ...
  "匠人的冶金术：第4阶段": icon("匠人的冶金术：第4阶段.jpg"),
  "高级匠人的裁缝术自选箱子": icon("高级匠人的裁缝术自选箱子.jpg"),
  "高级匠人的冶金术自选箱子": icon("高级匠人的冶金术自选箱子.jpg"),
  "幸运材料随机箱子": icon("幸运材料随机箱子.jpg"),
  "遗物核心自选箱子": icon("遗物核心箱子.jpg"),
  "英雄炼狱钥匙兑换券": icon("英雄炼狱钥匙.jpg"),
  "幻境挑战次数+1兑换券": icon("幻境券.jpg"),
  "飞翔之石刻印自定套件": icon("飞翔之刻印自定套件.jpg"),
  "稀有炼狱钥匙兑换券": icon("稀有炼狱钥匙兑换券.jpg"),
  "传说卡牌礼物4": icon("传说卡牌4.jpg"),
  "造物战斗刻印书自选袋子": icon("遗物战斗刻印书箱子.jpg"),
  "传说炼狱钥匙兑换券": icon("传说炼狱钥匙兑换券.jpg"),
  "加工星石属性刷新券": icon("加工星石属性刷新券.jpg"),
  "4阶突破石自选箱子": icon("突破石箱子.jpg"),
  "冰川之息箱子": icon("冰川之息箱子.jpg"),
  "熔岩之息箱子": icon("熔岩之息箱子.jpg"),
  "稀有-英雄星石箱子": icon("稀有~英雄星石箱子.jpg"),
  "高级-英雄星石箱子": icon("稀有~英雄星石箱子.jpg"),
  "稀有~英雄星石箱子": icon("稀有~英雄星石箱子.jpg"),
  "星石加工初始化券": icon("星石加工初始化券.jpg"),
...
const inferredItemIconFiles = [
  ...
  ["冰川之息", "冰川之息箱子.jpg"],
  ["熔岩之息", "熔岩之息箱子.jpg"],
  ["稀有-英雄星石", "稀有~英雄星石箱子.jpg"],
  ["稀有~英雄星石", "稀有~英雄星石箱子.jpg"],
  ["英雄星石", "英雄星石箱子.jpg"],
  ["星石加工", "星石加工初始化券.jpg"],
  ["属性刷新", "加工星石属性刷新券.jpg"],
  ["传说炼狱钥匙", "传说炼狱钥匙兑换券.jpg"],
  ["稀有炼狱钥匙", "稀有炼狱钥匙兑换券.jpg"],
  ["英雄炼狱钥匙", "英雄炼狱钥匙.jpg"],
  ["遗物核心", "遗物核心箱子.jpg"],
  ["战斗刻印", "遗物战斗刻印书箱子.jpg"],
  ["传说卡牌礼物", "传说卡牌4.jpg"],
...
function buildGiftPackCollage() {
  ...
  const cards = rows.map(({ pack, calc }) => {
    ...
    const media = paths.length
      ? paths.map((path, index) => `<img class="${index ? "share-collage-detail" : "share-collage-cover"}" src="${escapeAttr(path)}" alt="${escapeAttr(pack.name)}${index ? `详情${index}` : "封面"}" loading="eager" decoding="sync">`).join("")
...
function looksLikeBrokenPath(path) {
  return /�|鍛|鐭|煶|埜|彺|寘|绠|瓙|€|\/_00\d{2}_/.test(String(path || ""));
}
